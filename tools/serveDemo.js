...
http.createServer((req, res) => {
  ...
  const allowed = /^\/(?:ui|lib|vendor|vendor\/fonts)\/[a-zA-Z0-9._-]+$/.test(target) || target === '/fixtures/current/snapshot.json' || /^\/validation\/[a-zA-Z0-9_-]+\.(?:json|md)$/.test(target) || /^\/icon[0-9]+\.png$/.test(target);
