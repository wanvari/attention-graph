...
(function(root, factory) {
  ...
  // adjudication gate, never a displayed probability (spec D4). The
  // cross-domain logic survives only as a penalty, not a merge veto (§4.3.4).
  function heuristicConfidence(clusterPages, cohesion) {
    ...
    return { value, dominantDomainShare, mixedDomainPenalty };
  }
